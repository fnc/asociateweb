...
class PublicarEstadoResultadoCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        ->setSubject("Se han acreditado ganancias del emprendimiento Fabrica de chocolates")//.$emprendimiento->getNombre())
        ->setFrom('noreply@asociateya.com')
        ->setTo('ftiberti87@hotmail.com')
        ->setBody($this->getContainer()->get('templating')->render(
                 // app/Resources/views/Emails/registration.html.twig
                 'asociateyaBundle:Emails:estadoResultado.html.twig',
                 array('emprendimiento' => "Fabrica de chocolates",
                    'inversor' => "8305826490205827563984570",
                    'monto' => 30000000000)
             ),
